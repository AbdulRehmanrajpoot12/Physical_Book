...
const config = {
  ...
  url: 'https://your-ai-physical-book-site.example.com',
  ...
  themeConfig:
    ...
    ({
      ...
      // Inject environment variables as global JavaScript variables
      headTags: [
        {
          tagName: 'script',
          attributes: {
          ...
          innerHTML: `
            window.RAG_CONFIG = {
              RAG_AGENT_URL: ${JSON.stringify(process.env.RAG_AGENT_URL || 'http://localhost:8000')},
            };
          `,
        },
      ],
